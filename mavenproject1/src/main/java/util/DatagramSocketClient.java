 ...
 * close a socket, set timeouts, etc. Of special note is the {@link #setDatagramSocketFactory  setDatagramSocketFactory
 * }
 * method, which allows you to control the type of DatagramSocket the
 * DatagramSocketClient creates for network communications. This is especially
 * useful for adding things like proxy support as well as better support for
 * applets. For example, you could create a
 * {@link org.apache.commons.net.DatagramSocketFactory} that requests browser
 * security capabilities before creating a socket. All classes derived from
 * DatagramSocketClient should use the {@link #_socketFactory_  _socketFactory_ }
 * member variable to create DatagramSocket instances rather than instantiating
 * them by directly invoking a constructor. By honoring this contract you
 * guarantee that a user will always be able to provide his own Socket
...
public abstract class DatagramSocketClient {
     ...
     * Also sets the timeout on the socket to the default timeout set by {@link #setDefaultTimeout  setDefaultTimeout()
     * }.
     * <p>
     * _isOpen_ is set to true after calling this method and _socket_ is set to
     * the newly opened socket.
     *
     * @throws SocketException If the socket could not be opened or the timeout
     * could not be set.
     **
     */
     ...
     * the timeout on the socket to the default timeout set by {@link #setDefaultTimeout  setDefaultTimeout()
     * }.
     * <p>
     * _isOpen_ is set to true after calling this method and _socket_ is set to
     * the newly opened socket.
